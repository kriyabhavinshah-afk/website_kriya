...
export default function RoyalVanLentMoodboardLayout({ project }: RoyalVanLentMoodboardLayoutProps) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-8 sm:py-10 scroll-mt-20 sm:scroll-mt-24 snap-center">
        <div className="max-w-xl mx-auto w-full flex-shrink-0">
          <figure className="space-y-3 group py-1 overflow-visible">
        ...
        <div
          ref={moodBoardRef}
          className="mt-12 sm:mt-16 w-full flex-shrink-0"
        >
